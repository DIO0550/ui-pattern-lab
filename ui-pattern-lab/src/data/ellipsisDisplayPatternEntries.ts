...
const baseEllipsisDisplayPatternEntries = [
  {
    ...
    title: '1行省略',
    summary:
      '横幅を固定した一覧やラベル列で、1行のまま省略記号を使って密度を保ちます。',
    problem:
      '長いタイトルや補足文がそのまま入ると、一覧の高さが項目ごとにばらつき視線移動のリズムが崩れます。',
    solution:
      '幅制約と `text-overflow: ellipsis` を組み合わせ、見た目は 1 行に揃えつつ全文確認は別導線へ逃がします。',
    whenToUse:
      'ラベル列、通知一覧、カード見出しなど、行高をそろえることが最優先で全文は別面でも許容できる場面に向いています。',
    accessibilityNotes:
